  ...
  <div class="container">
    ...
    <div class="notion-page-content"
      ...
      <div data-block-id="93f206ad-3686-4937-8bc3-405c844ba4de" class="notion-selectable notion-text-block"
        ...
        <Popper :show="showPopper" placement="bottom-start" content="This is the Popper content 🍿" style="width: 100%;">
          <Popper :hover="true" offsetDistance="0" placement="left" style="width: 100%;">
            <template #content>
              <div>Handle</div>
            </template>
